        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5 flex items-center text-sm/6">
            ...
            <button type="button"
                    ...
                    class="w-auto h-50= ml-2 border border-gray-300 shadow-sm font-medium rounded-md text-gray-700 bg-blue-500 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              发送验证码
            </button>
          </div>
